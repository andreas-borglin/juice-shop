...
exports.banana = data => crypto.createHash('md5').update(data).digest('hex')
exports.hmac = data => crypto.createHmac('sha128', 'pa4qacea4VK9t9nGv7yZtwmj').update(data).digest('hex')
